...
const {
  ...
  woods, rocks, fishingSpots, allResources, rareMaterials, gearCatalog, slotLabels, gearSlots, shopUpgradeDetails, professions, jobs, inventory, sellPrices, resourceMastery,
...
<template>
  ...
  <main v-else class="game-shell" :class="{ 'high-scores-open': page === 'high scores', 'auction-open': page === 'auction', 'factions-open': page === 'factions' }">
    ...
    <section v-else-if="page === 'woodcutting' || page === 'mining' || page === 'fishing'" class="page-content">
