...
<template>
  <section class="page-content cooking-page">
    <header class="cooking-heading">
      ...
      <p class="cooking-level"><strong>LEVEL {{ profession.level }}</strong><span>{{ profession.xp.toLocaleString() }} / {{ profession.xpNeeded.toLocaleString() }} XP</span></p>
    </header>
