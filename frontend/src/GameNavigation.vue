...
<style scoped>
.area-navigation{position:sticky;top:68px;z-index:9;min-height:64px;margin:0;padding:9px clamp(12px,2vw,30px);display:flex;justify-content:center;gap:18px;border-bottom:1px solid #ffffff0d;background:#0b0c10f5;backdrop-filter:blur(9px);overflow-x:auto;scrollbar-width:thin;scrollbar-color:#8b6835 #0b0c10}.navigation-group{flex:0 0 auto}.navigation-group>span{display:block;margin:0 0 3px 7px;color:#515359;font-size:7px;font-weight:800;letter-spacing:.14em;text-transform:uppercase}.navigation-group>div{display:flex;align-items:center;gap:2px}.navigation-group button{min-height:38px;padding:9px 12px;border:1px solid transparent;color:#74777c;background:transparent;font-size:9px;font-weight:700;letter-spacing:.06em;text-transform:uppercase;white-space:nowrap;cursor:pointer}.navigation-group button b{margin-right:6px;color:#8c7042;font-size:11px}.navigation-group button:hover{color:#c5c6c7;background:#ffffff05}.navigation-group button.selected{border-color:#d5a54e45;color:#edc46f;background:#d5a54e0c}.navigation-group button.selected b{color:#e4b45d}.cooking-separator{margin:0 5px;color:#d88445;font:800 19px/1 Cinzel;text-shadow:0 0 8px #d8844588}
@media(max-width:720px){.area-navigation{top:62px;min-height:50px;padding:5px 7px;justify-content:flex-start;gap:3px}.navigation-group>span{display:none}.navigation-group>div{gap:0}.navigation-group button{min-height:42px;padding:8px 11px;font-size:8px}.navigation-group button b{margin-right:5px;font-size:10px}.cooking-separator{margin:0 3px;font-size:17px}}
</style>
