...
export const gearCatalog: Record<string, Gear> = {
  ...
  loggerGloves: { id: 'loggerGloves', name: 'Artisan Gloves', slot: 'gloves', tier: 3, icon: '🧤', description: 'A surer grip means better yields.', bonuses: { woodYield: 1, miningYield: 1, woodCrit: 2, miningCrit: 2 } },
  silverRing: { id: 'silverRing', name: 'Ring of Fortune', slot: 'ring', tier: 6, icon: '💍', description: 'Sometimes there is more than expected.', bonuses: { fortune: 10 } },
  moonAmulet: { id: 'moonAmulet', name: 'Moonstone Amulet', slot: 'amulet', tier: 9, icon: '📿', description: 'Focuses each perfect strike.', bonuses: { critPower: 1, woodCrit: 5, miningCrit: 5, maxHealth: 30 } },
...
export const recipes: Recipe[] = [
  ...
  { id: 'oakHatchetRecipe', name: 'Oaksteel Hatchet', category: 'tools', description: 'A fast, high-yield logging tool.', duration: 55, costs: { 'Pinebound Frame': 2, 'Oak Plank': 5, 'Iron Fittings': 3 }, outputGear: 'oakHatchet', progress: 0 },
  { id: 'mapleHatchetRecipe', name: 'Ember Maple Hatchet', category: 'tools', description: 'A fortunate mid-tier hatchet with excellent critical chance.', duration: 78, costs: { 'Pinebound Frame': 2, 'Iron Fittings': 4, 'Tempered Tool Head': 2, 'Ancient Resin': 3 }, outputGear: 'mapleHatchet', progress: 0 },
  { id: 'ironPickaxeRecipe', name: 'Iron Pickaxe', category: 'tools', description: 'A fast, high-yield mining tool.', duration: 55, costs: { 'Pinebound Frame': 2, 'Iron Fittings': 3, 'Tempered Tool Head': 2 }, outputGear: 'ironPickaxe', progress: 0 },
  { id: 'silverPickaxeRecipe', name: 'Silvervein Pickaxe', category: 'tools', description: 'An advanced pickaxe tuned for rare finds.', duration: 105, costs: { 'Iron Fittings': 4, 'Tempered Tool Head': 3, 'Silver Mechanism': 3, 'Ore Crystal': 3 }, outputGear: 'silverPickaxe', progress: 0 },
  { id: 'yewHatchetRecipe', name: 'Yew Moon Hatchet', category: 'tools', description: 'Exceptional speed, yield, and critical power.', duration: 110, costs: { 'Pinebound Frame': 3, 'Tempered Tool Head': 3, 'Silver Mechanism': 4, 'Resin Binding': 3 }, outputGear: 'yewHatchet', progress: 0 },
